    ...
    <div>
        <div class="info">
            ...
            <el-form-item prop="phoneNum" label="电话号码">
                <el-input  v-model="registerForm.phoneNum" placeholder="请输入电话号码"></el-input>
            </el-form-item>
            <el-form-item prop="email" label="邮箱">
                <el-input  v-model="registerForm.email" placeholder="请输入邮箱"></el-input>
            </el-form-item>
            <el-form-item prop="birth" label="生日">
                <!-- 使用 editable 属性为 false 就不要使用inputType属性 只能选择-->
            ...
            <el-form-item prop="introduction" label="签名">
                <el-input  v-model="registerForm.introduction" placeholder="请输入签名"></el-input>
            </el-form-item>
            <el-form-item prop="location" label="地区">
                <el-select  v-model="registerForm.location" style="width:100%" placeholder="选择地区">
                    <!-- :label="item.label" 显示的内容是label  -->
                  <el-option v-for="item, cities in cities" :key="item.value" :label="item.label" :value="item.value"></el-option>
                </el-select>
            </el-form-item>
            </el-form>
            <div class="btn">
                <!-- goback(-1)" -1 就是回到原来的界面   primary 颜色会变-->
                <el-button type="primary" @click="SignUp">修改</el-button>
...
import {getUserId,updateUserMsg} from '../api/index'
export default {
    name:'info',
    mixins:[mixin],
    data() {
    ...
    mounted(){
        this.getUserOfConsumer(this.userId)
    },
    methods:{
      getUserOfConsumer(userId){
        getUserId(userId)
         .then(res=>{
